...
(function() {
  ...
  makeBookmarklet = function(idBoard, idList) {
    ...
    token = Trello.token();
    key = Trello.key();
    bookmarklet = "(function(){function b(){if(window.saveTrelloCard)saveTrelloCard(\"" + idList + "\",\"" + key + "\",\"" + token + "\");else setTimeout(b,0)}var a=document.createElement(\"script\");a.setAttribute(\"type\",\"text/javascript\");a.setAttribute(\"charset\",\"UTF-8\");a.setAttribute(\"src\",\"https://rawgit.com/thedufer/Trello-Bookmarklet-Maker/gh-pages/saveToCard.js\");document.body.appendChild(a);setTimeout(b,0)})()";
    a = $('.js-show-link');
